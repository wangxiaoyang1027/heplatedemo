...
namespace SqlHelper
{
    ...
    {
       // public static readonly string default_connection_str = ConfigurationManager.ConnectionStrings["SqlGZL"].ConnectionString;
        //public static readonly string default_connection_str = "Data Source=10.17.23.9;User ID=infocenter;Password=ifct168;Initial Catalog=hmcerp;";

        public static readonly string default_connection_str = "Data Source=10.17.10.202;User ID=sa;Password=TAIWANqq123456;Initial Catalog=WFCDB;";
