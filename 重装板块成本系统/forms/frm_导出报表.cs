...
{
    public partial class frm_导出报表 : Form
    {
        ...
        private void frm_导出报表_Load(object sender, EventArgs e)
        {
            label1.Text =  " 重装板块  在制品卡片导出 ! ";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            wk = app.Workbooks.Open(filedir+ "总成本结算模板.xls");
            ...
            try
            {
                ...
                SqlDataReader dr;
                dr = dal1.get原始凭证报表(mydate.Value);
                ...
                if (dr.HasRows)
                {
                    ...
                    {
                        dr.GetValues(myobj);
                        myrng = mysheet.Range[mysheet.Cells[temprow, 1], mysheet.Cells[temprow, 21]];
