...
{
    public partial class frm_铆焊齿轮成本结算表 : Form
    {
        public frm_铆焊齿轮成本结算表()
        {
            InitializeComponent();
        }

        private void frm_铆焊齿轮成本结算表_Load(object sender, EventArgs e)
        {
            MinimizeBox = false;
            MaximizeBox = false;
        ...
        private void btn_export_Click(object sender, EventArgs e)
        {
            ...
            wk = app.Workbooks.Open(filedir + "铆焊齿轮成本结算模板.xls");
            ...
            try
            {
                ...
                SqlDataReader dr = dal1.get铆焊齿轮结算表(mydate.Value);
                myobj = new object[5];
                ...
                if (dr.HasRows)
                {
                    ...
                    {
                        dr.GetValues(myobj);
                        myrng = mysheet.Range[mysheet.Cells[temprow, 1], mysheet.Cells[temprow, 5]];
