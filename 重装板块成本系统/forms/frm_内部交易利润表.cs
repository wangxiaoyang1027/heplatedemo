...
{
    public partial class frm_内部交易利润表 : Form
    {
        public frm_内部交易利润表()
        {
            InitializeComponent();
        ...
        private void frm_内部交易利润表_Load(object sender, EventArgs e)
        {
            MinimizeBox = false;
            MaximizeBox = false;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            wk = app.Workbooks.Open(filedir + "产品销售利润表（内部交易）.xls");
            ...
            try
            {
                ...
                SqlDataReader dr = dal1.get内部交易利润表(mydate.Value);
                myobj = new object[16];

                mysheet = wk.Worksheets["内部交易利润表"];
